...
public class ReciboLocalidadPdf implements ReciboLocalidad {
	@Autowired
	...
	private static Logger logger = Logger.getLogger(ReciboLocalidadPdf.class);
	...
	private void crearPdf(List<DetalleRecibo> detalleRecibo, DatosPago datosPago) throws Exception {
		...
		String rutaReciboPdf = utils.getRutaArchivo(empleado, solicitudUsuario.getFormato());
